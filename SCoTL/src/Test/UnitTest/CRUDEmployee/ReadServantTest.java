...
public class ReadServantTest 
{
    ...
    private static void ReadServants()
    {
        var servants = CRUDEmployee.GetServants();
    ...
    private static void ReadServant()
    {
        var servant = CRUDEmployee.GetServant("1112");
        if(servant != null)
        {
            System.out.println(servant);
        }
