...
public class SystemClientReadWarehouseActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_system_client_read_warehouse);

        GetReferences();

        DefineListButtonEvents();
        DefineListButtonEvents();
        DefineRegisterButtonEvent();
    }

    private void GetReferences()
    {
        m_idText = findViewById(R.id.system_client_read_warehouse_id_edit_text);
        m_ownerCpfText = findViewById(R.id.system_client_read_warehouse_owner_cpf_edit_text);
        m_stateText = findViewById(R.id.system_client_read_warehouse_state_edit_text);
        m_cityText = findViewById(R.id.system_client_read_warehouse_city_edit_text);
        m_streetText = findViewById(R.id.system_client_read_warehouse_street_edit_text);
        m_residentialNumberText = findViewById(R.id.system_client_read_warehouse_number_edit_text);

        m_listButton = findViewById(R.id.system_client_read_warehouse_list_button);
        m_registerButton = findViewById(R.id.system_client_read_warehouse_register_button);
        m_withPastRegisterSwitch = findViewById(R.id.system_client_read_warehouse_with_past_register_switch);

        m_tableLayout = findViewById(R.id.system_client_read_warehouse_table_layout);
    }

    private void DefineRegisterButtonEvent()
    {
        ...
        m_registerButton.setOnClickListener
                (
                        view ->
                        {
                            startActivity(new Intent(this, RegisterWarehouse.class));
                        }
                );
    }
